    ...
    >
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden">
        ...
        <div className={`px-4 ${!expanded && 'flex justify-center'}`}>
          {expanded ? (
            <a href="#" 
              className={`flex items-center px-3 py-2 ${themeClasses.sidebarText} rounded-lg hover:bg-[hsl(var(--primary)_/_0.1)] transition-all duration-200`}
            >
              <svg className="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
              </svg>
              <span className="whitespace-nowrap transition-all duration-300 opacity-100">Översikt</span>
            </a>
          ) : (
            <SidebarTooltip content="Dashboard">
              <a href="#" 
                className={`flex items-center justify-center mb-3 p-2 h-9 w-9 ${themeClasses.sidebarText} rounded-lg hover:bg-[hsl(var(--primary)_/_0.1)] transition-all duration-200`}
              >
        ...
        <div className={`px-4 pb-4 ${!expanded && 'flex flex-col items-center'}`}>
          ...
          <div className={`${expanded ? 'space-y-1' : 'space-y-4'}`}>
            {/* Datablad */}
            {expanded ? (
              <a href="#" className={`flex items-center px-3 py-2 ${themeClasses.sidebarText} hover:${themeClasses.text} rounded-lg hover:bg-[hsl(var(--primary)_/_0.1)] transition-all duration-200`}>
                <svg className="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                <span className="whitespace-nowrap transition-all duration-300 opacity-100">Datablad</span>
              </a>
            ) : (
              <SidebarTooltip content="Datablad">
                <a href="#" className={`p-2 h-9 w-9 ${themeClasses.sidebarText} hover:${themeClasses.text} justify-center rounded-lg hover:bg-[hsl(var(--primary)_/_0.1)] transition-all duration-200 flex items-center`}>
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                </a>
            ...
            {expanded ? (
              <a href="#" className={`flex items-center px-3 py-2 ${themeClasses.sidebarText} hover:${themeClasses.text} rounded-lg hover:bg-[hsl(var(--primary)_/_0.1)] transition-all duration-200`}>
                ...
                <span className="whitespace-nowrap transition-all duration-300 opacity-100">Manualer</span>
              </a>
            ) : (
              <SidebarTooltip content="Manualer">
                <a href="#" className={`p-2 h-9 w-9 ${themeClasses.sidebarText} hover:${themeClasses.text} justify-center rounded-lg hover:bg-[hsl(var(--primary)_/_0.1)] transition-all duration-200 flex items-center`}>
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                  </svg>
            ...
            {expanded ? (
              <a href="#" className={`flex items-center px-3 py-2 ${themeClasses.sidebarText} hover:${themeClasses.text} rounded-lg hover:bg-[hsl(var(--primary)_/_0.1)] transition-all duration-200`}>
                ...
                <span className="whitespace-nowrap transition-all duration-300 opacity-100">How-To Guider</span>
              </a>
            ) : (
              <SidebarTooltip content="How-To Guider">
                <a href="#" className={`p-2 h-9 w-9 ${themeClasses.sidebarText} hover:${themeClasses.text} justify-center rounded-lg hover:bg-[hsl(var(--primary)_/_0.1)] transition-all duration-200 flex items-center`}>
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                  </svg>
            ...
            {expanded ? (
              <a href="#" className={`flex items-center px-3 py-2 ${themeClasses.sidebarText} hover:${themeClasses.text} rounded-lg hover:bg-[hsl(var(--primary)_/_0.1)] transition-all duration-200`}>
                ...
                <span className="whitespace-nowrap transition-all duration-300 opacity-100">Installationsfiler</span>
              </a>
            ) : (
              <SidebarTooltip content="Installationsfiler">
                <a href="#" className={`p-2 h-9 w-9 ${themeClasses.sidebarText} hover:${themeClasses.text} justify-center rounded-lg hover:bg-[hsl(var(--primary)_/_0.1)] transition-all duration-200 flex items-center`}>
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" />
                  </svg>
        ...
        <div className={`px-4 pb-4 ${!expanded && 'flex flex-col items-center'}`}>
          ...
          <div className={`${expanded ? 'space-y-1' : 'space-y-4'}`}>
            {/* Mätinsamling */}
            {expanded ? (
              <a href="#" className={`flex items-center px-3 py-2 ${themeClasses.primaryText} rounded-lg bg-[hsl(var(--primary)_/_0.1)] transition-all duration-200`}>
                <svg className="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                </svg>
                <span className="whitespace-nowrap transition-all duration-300 opacity-100">Mätinsamling</span>
              </a>
            ) : (
              <SidebarTooltip content="Mätinsamling">
                <a href="#" className={`p-2 h-9 w-9 ${themeClasses.primaryText} justify-center rounded-lg bg-[hsl(var(--primary)_/_0.1)] transition-all duration-200 flex items-center`}>
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                  </svg>
                </a>
            ...
            {expanded ? (
              <a href="#" className={`flex items-center px-3 py-2 ${themeClasses.sidebarText} hover:${themeClasses.text} rounded-lg hover:bg-[hsl(var(--primary)_/_0.1)] transition-all duration-200`}>
                ...
                <span className="whitespace-nowrap transition-all duration-300 opacity-100">Egenprovning</span>
              </a>
            ) : (
              <SidebarTooltip content="Egenprovning">
                <a href="#" className={`p-2 h-9 w-9 ${themeClasses.sidebarText} hover:${themeClasses.text} justify-center rounded-lg hover:bg-[hsl(var(--primary)_/_0.1)] transition-all duration-200 flex items-center`}>
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                  </svg>
      ...
      <div className="shrink-0">
        ...
        <div className={`${expanded ? 'px-4 pt-3' : 'flex justify-center pt-3'}`}>
          {expanded ? (
            <a href="#" className={`flex items-center px-3 py-2 ${themeClasses.mutedText} hover:${themeClasses.text} rounded-lg hover:bg-[hsl(var(--primary)_/_0.1)] transition-all duration-200 mb-2`}>
              <svg className="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <SidebarTooltip content="Hjälp">
              <button className={`p-2 h-9 w-9 ${themeClasses.sidebarText} hover:${themeClasses.text} rounded-lg hover:bg-[hsl(var(--primary)_/_0.1)] transition-all duration-200 flex items-center justify-center mb-3`}>
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </button>
        ...
        <div className={`${expanded ? 'px-4' : 'flex justify-center'}`}>
          {expanded ? (
            <a href="#" className={`flex items-center px-3 py-2 text-[hsl(var(--destructive))] hover:text-[hsl(var(--destructive)_/_0.8)] rounded-lg hover:bg-[hsl(var(--destructive)_/_0.1)] transition-all duration-200 mb-3`}>
              <svg className="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <SidebarTooltip content="Logga ut">
              <button className={`p-2 h-9 w-9 text-[hsl(var(--destructive))] hover:text-[hsl(var(--destructive)_/_0.8)] rounded-lg hover:bg-[hsl(var(--destructive)_/_0.1)] transition-all duration-200 flex items-center justify-center mb-3`}>
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                </svg>
              </button>
        ...
        {/* Sync component with fixed z-index popup */}
